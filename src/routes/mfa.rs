...
pub struct MfaRoutes<T = &'static str> {
    ...
    /// Post - consumes a single-use recovery code and completes the login
    pub login_mfa_recovery: T,
    #[cfg(feature = "sms")]
...
impl Default for MfaRoutes {
    fn default() -> Self {
        Self {
            ...
            login_mfa_recovery: "/login/mfa/recovery",
            #[cfg(feature = "sms")]
...
impl<'a> From<&'a MfaRoutes<String>> for MfaRoutes<&'a str> {
    fn from(value: &'a MfaRoutes<String>) -> Self {
        Self {
            ...
            login_mfa_recovery: &value.login_mfa_recovery,
            #[cfg(feature = "sms")]
...
impl<T: Display> MfaRoutes<T> {
    ...
    pub fn with_prefix(self, prefix: impl Display) -> MfaRoutes<String> {
        MfaRoutes {
            ...
            login_mfa_recovery: format!("{prefix}{}", self.login_mfa_recovery),
            #[cfg(feature = "sms")]
